...
update tutorial_lab set introduction = "Solve and graph equations for 3D volumes and surfaces, in cartesian, polar, or cylindrical coordinates. Topics include gradient, tangent, normal, divergence, curl, Green’s Theorem, Stokes’ Theorem, and Gauss’ Theorem." where tutorial_lab_id = 101;
update tutorial_lab set introduction = "Experiment with DC circuits using resisters, capacitors, and diodes. Topics include parallel and series resistance and capacitance, Ohm’s law, and Kirchhoff’s law." where tutorial_lab_id = 102;
update tutorial_lab set introduction = "Vary inclines, masses, and friction, while collecting and analyzing data on distance, time, and velocity. Topics include linear motion, collisions, and conservation of linear momentum." where tutorial_lab_id = 103;
...
update tutorial_lab set introduction = "Learn Discrete Mathematics." where tutorial_lab_id = 105;
update tutorial_lab set introduction = "Learn Beginning Orbital Trajectories." where tutorial_lab_id = 106;
update tutorial_lab set introduction = "Learn 2D and 3D Collisions." where tutorial_lab_id = 107;
update tutorial_lab set introduction = "Learn Beginning Springs and Pendulums." where tutorial_lab_id = 108;
