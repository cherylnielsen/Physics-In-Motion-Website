...
require_once('model/Section_List_Of_Students_View.php');
...
require_once('controller/Homework_View_Controller.php');
require_once('controller/Notice_View_Controller.php');
require_once('controller/Professor_Member_View_Controller.php');
require_once('controller/Section_List_Of_Students_View_Controller.php');
require_once('controller/Section_Rating_View_Controller.php');
require_once('controller/Section_View_Controller.php');
