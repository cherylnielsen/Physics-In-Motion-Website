...
class NoticeController extends DatabaseController {
	...
	//($notice_id, $to_user_id, $from_user_id, $date_sent, $notice_subject, $notice_text)
	...
	public function saveNew(&$notice)
	{
		...
		$query = "insert into notice (to_user_id, from_user_id, date_sent, notice_subject, notice_text) 
				values('$to_user_id', '$from_user_id', 'now()', '$notice_subject', '$notice_text')";
