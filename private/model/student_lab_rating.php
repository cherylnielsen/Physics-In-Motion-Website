...
class student_lab_rating {
	...
	public function student_lab_rating() {}
	
	public function student_lab_rating($rating_id, $lab_id, $student_id, $date_posted, $lab_rating, $comments)
	{
	...
	public function initialize($rating_id, $lab_id, $student_id, $date_posted, $lab_rating, $comments)
	{
		$this->rating_id = $rating_id;
		$this->lab_id = $lab_id;
		$this->student_id = $student_id;
